...
# Ну и напоследок все-таки костыльный пинг через статически настроенный Vxlan:
# Ping Results to 192.168.0.3 from VPCS

| Sequence | Bytes | From         | TTL | Time      |
|----------|-------|--------------|-----|-----------|
| 1        | 84    | 192.168.0.3  | 64  | 23.863 ms |
| 2        | 84    | 192.168.0.3  | 64  | 19.956 ms |
| 3        | 84    | 192.168.0.3  | 64  | 23.318 ms |
| 4        | 84    | 192.168.0.3  | 64  | 18.566 ms |
| 5        | 84    | 192.168.0.3  | 64  | 17.967 ms |

# VPCS Network Configuration
